...
Sub CATTitleBlockText()
  ...
  CreateTextAF Text_12,GetOH() + Col(10) + 4.  ,GetOV() + Row(4)  ,"TitleBlock_Text_Weight" , catMiddleCenter   ,3  '件数
  ...
  CreateTextAF Text_17,GetOH() + Col(7) + 8.  ,GetOV() + Row(1) + 3.5  ,"TitleBlock_Text_Audit" , catMiddleCenter   ,3  '阶段标记
  ...
  ' CreateTextAF(Text_13,GetOH() + Col(14) + 7.5  ,GetOV()+ Row(4)  ,"TitleBlock_Text_asm" , catMiddleCenter   ,3).WrappingWidth = 14  '装配名称
  ...
  ' Texts.GetItem("TitleBlock_Text_asm").Properties.Mirror = catTextHorizontalAndVerticalFlip
  CreateTextAF Text_08,GetOH() + Col(14) + 7.5  ,GetOV()+ Row(5) + 3.5 ,"TitleBlock_Text_Type" , catMiddleCenter   ,3  '型号
...
Sub CATLinks()
  ...
  If ProductDrawn <> Nothing Then
    ...
    Texts.GetItem("TitleBlock_Text_EnoviaV5_Effectivity_1").Mirror = catTextHorizontalFlip
    Texts.GetItem("TitleBlock_Text_Name_1").Text = ProductDrawn.Definition
    Texts.GetItem("TitleBlock_Text_Material_1").Text = ProductDrawn.Material
